-- PMO Monitoring & Evaluation - V1 Minimal Schema (Firebird SQL)
-- Strict creation order, Firebird-compatible types, and domains for enums
-- UUID stored as CHAR(36), JSON as BLOB SUB_TYPE TEXT
...
CREATE TABLE construction_projects (
  ...
  -- Firebird: replace POINT with latitude/longitude
