...
export function HeroSection({ onNavigate, onSignIn }: HeroSectionProps) {
  ...
  return (
    <section className="relative py-20 lg:py-28 overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-50 via-white to-amber-50/30 dark:from-emerald-950/30 dark:via-gray-900 dark:to-amber-950/20">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-400 mb-8 max-w-4xl mx-auto leading-relaxed">
            ...
            <span className="font-semibold text-emerald-700 dark:text-emerald-400"> Caraga State University's </span>
          ...
          <div className="mb-10 flex flex-wrap justify-center gap-4 text-sm">
            {keyFeatures.map((feature, index) => (
              <div key={index} className="flex items-center gap-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur px-4 py-2 rounded-full border border-emerald-100 dark:border-emerald-800">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="text-center p-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur rounded-xl border border-emerald-100 dark:border-emerald-800 shadow-sm">
              <div className="text-2xl lg:text-3xl font-bold text-emerald-600 dark:text-emerald-400 mb-1">127+</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Active Projects</div>
            </div>
            <div className="text-center p-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur rounded-xl border border-amber-100 dark:border-amber-800 shadow-sm">
              <div className="text-2xl lg:text-3xl font-bold text-amber-600 dark:text-amber-400 mb-1">₱2.8B</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Budget Managed</div>
            </div>
            <div className="text-center p-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur rounded-xl border border-emerald-100 dark:border-emerald-800 shadow-sm">
              <div className="text-2xl lg:text-3xl font-bold text-emerald-600 dark:text-emerald-400 mb-1">2</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Campuses</div>
            </div>
            <div className="text-center p-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur rounded-xl border border-amber-100 dark:border-amber-800 shadow-sm">
              <div className="text-2xl lg:text-3xl font-bold text-amber-600 dark:text-amber-400 mb-1">15K+</div>
