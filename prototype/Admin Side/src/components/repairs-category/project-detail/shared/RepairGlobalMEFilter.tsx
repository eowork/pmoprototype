/**
 * Repair Global ME Filter - Exclusive for Repairs Category
 * Global filter component for Monitoring & Evaluation data
 */
...
import { formatDate } from '../../../construction-infrastructure/utils/analyticsHelpers';
import { MEFilter } from '../../../construction-infrastructure/types/METypes';

interface RepairGlobalMEFilterProps {
  projectId: string;
...
export function RepairGlobalMEFilter({
  projectId,
  currentFilter,
  onFilterChange,
  onClearFilter,
  ...
  const hasActiveFilters = (enhancedFilter.status && enhancedFilter.status !== 'all') || 
    ...
    (enhancedFilter.fundingSource && enhancedFilter.fundingSource !== 'General Repairs');
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 border-t border-gray-200 pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      value={enhancedFilter.fundingSource || 'General Repairs'} 
              ...
              <div className="flex items-center justify-between bg-blue-50 border border-blue-200 rounded-lg p-3">
                <div className="flex items-center gap-4 flex-wrap text-sm">
                  <div className="flex items-center gap-1">
                    <span className="text-blue-900">Period:</span>
                    <Badge variant="outline" className="text-xs bg-blue-100 text-blue-800 border-blue-200">
                      {enhancedFilter.period} View
                    </Badge>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="text-blue-900">Range:</span>
                  ...
                  {enhancedFilter.supplierContractor && (
                    <div className="flex items-center gap-1">
                      <span className="text-blue-900">Contractor:</span>
                      <Badge variant="outline" className="text-xs bg-blue-100 text-blue-800 border-blue-200">
                        {enhancedFilter.supplierContractor}
                      </Badge>
                    </div>
