...
interface RepairDateRangeFilterProps {
  dateRange: RepairDateRange;
  onDateRangeChange: (range: RepairDateRange) => void;
  className?: string;
}

export function RepairDateRangeFilter({ dateRange, onDateRangeChange, className }: RepairDateRangeFilterProps) {
  ...
  return (
    <Card className={cn("border border-gray-200 bg-white p-4", className)}>
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        <div className="flex items-center gap-2 min-w-[120px]">
          <Filter className="h-4 w-4 text-gray-600" />
          <Label className="text-sm text-gray-700">Date Filter</Label>
        </div>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button 
                    variant="outline" 
                    className={cn(
                      "w-[140px] justify-start text-left border-gray-200",
...
export function filterRepairProjectsByDateRange(
