/**
 * Project Assignment Helper Utilities
...
export function isProjectShared(projectId: string): boolean {
  const assignments = enhancedRBACService.getProjectStaff(projectId);
...
export function hasProjectAccess(
  ...
  const assignments = enhancedRBACService.getAssignedProjects(userEmail);
