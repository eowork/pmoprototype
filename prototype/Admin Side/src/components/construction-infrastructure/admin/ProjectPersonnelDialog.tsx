...
import { UserPlus, Trash2, Shield, Eye, Edit2, FileText, Upload, Lock, CheckCircle, Users, ShieldCheck, Info, X } from 'lucide-react';
...
export function ProjectPersonnelDialog({
  ...
  const assignedPersonnel = constructionInfrastructureRBACService.getProjectStaff(project.id);
  ...
  const handleAssignPersonnel = () => {
    ...
    if (success) {
      toast.success(`${staff.name} assigned to ${project.projectTitle}`);
      setSelectedStaff('');
      setPermissions({
        canEdit: true,
        canDelete: false,
  ...
  const handleRemovePersonnel = (staffEmail: string) => {
    ...
    constructionInfrastructureRBACService.removeStaffFromProject(project.id, staffEmail);
          ...
          <DialogTitle className="flex items-center gap-4 text-xl pr-12">
            ...
            <div>
              ...
              <p className="text-sm font-normal text-green-100 mt-2 leading-relaxed">
                Manage access control for {project.projectTitle}
              </p>
            </div>
          </DialogTitle>
          <DialogDescription className="sr-only">
            Manage personnel assignments and access permissions for {project.projectTitle}. Assign staff members, configure their access rights, and control project visibility.
          </DialogDescription>
        </DialogHeader>
                ...
                {availableStaff.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label className="text-sm text-gray-700">Select Personnel</Label>
