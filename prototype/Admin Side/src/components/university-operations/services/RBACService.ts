/**
 * RBAC Service for University Operations
 * Handles personnel permissions and access control for University Operations data
 */
...
export class UniversityOperationsRBACService {
  private static instance: UniversityOperationsRBACService;
  ...
  public static getInstance(): UniversityOperationsRBACService {
    if (!UniversityOperationsRBACService.instance) {
      UniversityOperationsRBACService.instance = new UniversityOperationsRBACService();
    }
    return UniversityOperationsRBACService.instance;
  }
...
export const universityOperationsRBACService = UniversityOperationsRBACService.getInstance();
