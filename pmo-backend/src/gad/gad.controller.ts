...
export class GadController {
  ...
  // --- Student Parity ---
  @Get('student-parity')
  findStudentParity(@Query() query: QueryParityDto) {
    return this.service.findStudentParity(query);
  }

  @Post('student-parity')
  @HttpCode(HttpStatus.CREATED)
  createStudentParity(
    @Body() dto: CreateStudentParityDto,
  ...
  updateStudentParity(
    ...
    @Body() dto: Partial<CreateStudentParityDto>,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  removeStudentParity(@Param('id', ParseUUIDPipe) id: string) {
    return this.service.removeStudentParity(id);
  }

  @Patch('student-parity/:id/review')
  reviewStudentParity(
    @Param('id', ParseUUIDPipe) id: string,
    @Body() dto: ReviewParityDto,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  // --- Faculty Parity ---
  @Get('faculty-parity')
  findFacultyParity(@Query() query: QueryParityDto) {
    return this.service.findFacultyParity(query);
  }

  @Post('faculty-parity')
  @HttpCode(HttpStatus.CREATED)
  createFacultyParity(
    @Body() dto: CreateFacultyParityDto,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  updateFacultyParity(
    @Param('id', ParseUUIDPipe) id: string,
    @Body() dto: Partial<CreateFacultyParityDto>,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  @HttpCode(HttpStatus.NO_CONTENT)
  removeFacultyParity(@Param('id', ParseUUIDPipe) id: string) {
    return this.service.removeFacultyParity(id);
  }
  ...
  // --- Staff Parity ---
  @Get('staff-parity')
  findStaffParity(@Query() query: QueryParityDto) {
    return this.service.findStaffParity(query);
  }

  @Post('staff-parity')
  @HttpCode(HttpStatus.CREATED)
  createStaffParity(
    @Body() dto: CreateStaffParityDto,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  updateStaffParity(
    @Param('id', ParseUUIDPipe) id: string,
    @Body() dto: Partial<CreateStaffParityDto>,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  @HttpCode(HttpStatus.NO_CONTENT)
  removeStaffParity(@Param('id', ParseUUIDPipe) id: string) {
    return this.service.removeStaffParity(id);
  }
  ...
  // --- PWD Parity ---
  @Get('pwd-parity')
  findPwdParity(@Query() query: QueryParityDto) {
    return this.service.findPwdParity(query);
  }

  @Post('pwd-parity')
  @HttpCode(HttpStatus.CREATED)
  createPwdParity(
    @Body() dto: CreatePwdParityDto,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  updatePwdParity(
    @Param('id', ParseUUIDPipe) id: string,
    @Body() dto: Partial<CreatePwdParityDto>,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  @HttpCode(HttpStatus.NO_CONTENT)
  removePwdParity(@Param('id', ParseUUIDPipe) id: string) {
    return this.service.removePwdParity(id);
  }
  ...
  findIndigenousParity(@Query() query: QueryParityDto) {
    return this.service.findIndigenousParity(query);
  }

  @Post('indigenous-parity')
  @HttpCode(HttpStatus.CREATED)
  createIndigenousParity(
    @Body() dto: CreateIndigenousParityDto,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  updateIndigenousParity(
    @Param('id', ParseUUIDPipe) id: string,
    @Body() dto: Partial<CreateIndigenousParityDto>,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  @HttpCode(HttpStatus.NO_CONTENT)
  removeIndigenousParity(@Param('id', ParseUUIDPipe) id: string) {
    return this.service.removeIndigenousParity(id);
  }

  @Patch('indigenous-parity/:id/review')
  reviewIndigenousParity(
    @Param('id', ParseUUIDPipe) id: string,
    @Body() dto: ReviewParityDto,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  findGpbAccomplishments(@Query() query: QueryPlanningDto) {
    return this.service.findGpbAccomplishments(query);
  }

  @Post('gpb-accomplishments')
  @HttpCode(HttpStatus.CREATED)
  createGpbAccomplishment(
    @Body() dto: CreateGpbAccomplishmentDto,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  updateGpbAccomplishment(
    @Param('id', ParseUUIDPipe) id: string,
    @Body() dto: Partial<CreateGpbAccomplishmentDto>,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  // --- Budget Plans ---
  @Get('budget-plans')
  findBudgetPlans(@Query() query: QueryPlanningDto) {
    return this.service.findBudgetPlans(query);
  }
  ...
  updateBudgetPlan(
    @Param('id', ParseUUIDPipe) id: string,
    @Body() dto: Partial<CreateBudgetPlanDto>,
    @CurrentUser() user: JwtPayload,
  ) {
